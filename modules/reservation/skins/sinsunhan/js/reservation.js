(function () {
	...
	function boot() {
		...
		var L_REMAIN = root.getAttribute('data-remain') || '%d left';
		var L_FULL = root.getAttribute('data-full') || 'Full';
		...
		function selectDate(key) {
			...
			slots.forEach(function (s) {
				...
				small.textContent = s.available ? L_REMAIN.replace('%d', s.remain) : L_FULL;
